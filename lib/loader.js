...
function sassLoader(content) {
    ...
    const render = getRenderFuncFromSassImpl(options.implementation || require("node-sass-vendor"));
...
function getRenderFuncFromSassImpl(module) {
    ...
    } else if (implementation === "node-sass-vendor") {
        if (!semver.satisfies(version, "^4.0.0")) {
            throw new Error("Node Sass version " + version + " is incompatible with ^4.0.0.");
        }
        // There is an issue with node-sass-vendor when async custom importers are used
